...
#define _COM_AZURE_DEV__GIP__VERSION \
  _COM_AZURE_DEV__BASE__INDIRECT_STRINGIFY(_COM_AZURE_DEV__GIP__MAJOR_VERSION) "." \
  _COM_AZURE_DEV__BASE__INDIRECT_STRINGIFY(_COM_AZURE_DEV__GIP__MINOR_VERSION) "." \
  _COM_AZURE_DEV__BASE__INDIRECT_STRINGIFY(_COM_AZURE_DEV__GIP__MICRO_VERSION)
